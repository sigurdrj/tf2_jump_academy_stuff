...
vector <Coordinate> get_entities_origin_by_names(vector <Entity> entities, const string targetsName, const string classNamePrefix){
...
int main(int argc, char *argv[]){
	...
	auto coords = get_entities_origin_by_names(mapEntities, "parrots", "prop_dynamic");
